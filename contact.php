<?php
	...
	/*
		...
		trim()
		- Strip whitespace (or other characters) from the biginning and end of a string
		...
		- http://cal.php.net/manual/en/function.wordwrap.php

		mail()
		- Send mail
		- http://cal.php.net/manual/en/function.mail.php
	...
	<div id="contact">
		...
		<?php
			...
			if (isset($_POST['contact_submit'])) {
				...
				// Create a subject
				$subject = "$name sent you a meesage via your contact form";
				...
				// Check if the subscribe checkbox was chequed
